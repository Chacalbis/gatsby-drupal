...
3. Go to `/admin/structure/frontend_environment` and add one or more frontend environments, filling the required data
 for each.
...
4. The toolbar now should show your environments
5. Edit, delete or create entities of the types you have selected in step 1:
you should see the counter next to each environment in the toolbar increment.
6. When ready to trigger a deployment, click on the toolbar item for the environment,
